...
const Canvas = ({ boardId }: CanvasProps) => {
  ...
  const updateSelectionNet = useMutation(
    ({ storage, setMyPresence }, current, origin) => {
      ...
      const ids = findIntersectiongLayersWithRectangle(layerIds, layers, origin, current);
  ...
  const insertPath = useMutation(
    ({ storage, self, setMyPresence }) => {
      ...
      const id = nanoid();
      liveLayers.set(id, new LiveObject(petPointToPathLayer(pencilDraft, lastUsedColor)));
